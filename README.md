...
* [Day   9    (2024-04-20)](#8)   
* [Day   10   (2024-04-21)](#9)   
* [Day   11   (2024-04-29)](#10)  

***五月***
* [Day   12   (2024-05-07)](#11)  
* [Day   13   (2024-05-08)](#12)  
...
1. 做《CS 110L: Safety in Systems Programming》的assignment  

### 成果  

***  

1. 完成了第一周和第三周的assignment
...
1. 今天出校去完成小组作业了，回来补完剩下的assignment3...that's all  
...
1. 学了一些函数和Makefile的高级用法  
2. 学习了一些有关RISC-V嵌入式开发的知识，对面向硬件开发有了一定认识  

### 待解决的问题  

***  

1. 明天完成ch1和ch2，看看环境是否有问题  

### 感想与总结  

***  

1. 完善对于操作系统和RISC-V硬件开发的知识
...
1. 阅读《rCore-Tutorial-Book-v3》第一章  
2. 读《RISC-V上的操作系统 - 汪辰 - 2021春》第三章的代码  
3. 观看《2024 南京大学 “操作系统：设计与实现” (蒋炎岩)》第一讲  
...
1. 梳理了rCore的ch1的代码逻辑  
2. 梳理了RISC-V的ch3的部分代码逻辑  

### 待解决的问题  

***  

1. .bss 段的定义很模糊，现有的理解无法解释一些事情  

### 感想与总结  

***  

1. 在学完一遍汪辰老师的课后，对很多rCore的概念都补齐了，就比如在读ch1代码的时候发现RustSBI对硬件已经做好了抽象，但是在汪老师的RISC-V的Lab中则需要自己去查各个设备的手册来进行封装，rCore给我的感觉是从App一层一层往下剥，但是这样对于我这个没接触过多少硬件的人来说很难意识到RustSBI为我做了一什么，反而感觉这东西很鸡肋，但是从硬件往上看的话，反而就能能清楚某些东西存在的必要性了，所以今天读代码时，更多的是一种水到渠成的感觉  
...
1. 阅读《rCore-Tutorial-Book-v3》第二章  
2. 继续读《RISC-V上的操作系统 - 汪辰 - 2021春》第三章的代码  
3. 观看《2024 南京大学 “操作系统：设计与实现” (蒋炎岩)》第二讲  
